          ...
          <Row>
            <Container id='votes'>
              ...
              <ButtonGroup vertical className='better-votes'>
                <OverlayTrigger placement="top" overlay={<Tooltip id='buttonTooltip'>Mielestäni tämä on suositeltava kierrätysohje.</Tooltip>}>
                  <Button variant={labelLikeVariant} id="likeButton" onClick={handleLike} >
                    {/* <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi--arrowup" viewBox="0 0 16 16">
                ...
                <OverlayTrigger placement="top" overlay={<Tooltip id='buttonTooltip'>Mielestäni tämä kierrätysohje ei ole suositeltava.</Tooltip>}>
