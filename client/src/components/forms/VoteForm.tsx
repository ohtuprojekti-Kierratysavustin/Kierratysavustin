            ...
            <Container id='votes'>
              ...
              <ButtonGroup vertical className='better-votes'>
                <OverlayTrigger placement="top" overlay=
                  {like ? <Tooltip id='buttonTooltip'>Haluan perua tykkäykseni.</Tooltip>
                    : <Tooltip id='buttonTooltip'>Mielestäni tämä on suositeltava kierrätysohje.</Tooltip>}>
                  <Button variant={like ? 'success' : 'outline-success'} id="likeButton" onClick={handleLike} >
                ...
                <OverlayTrigger placement="top" overlay=
                  {disLike ? <Tooltip id='buttonTooltip'>Haluan perua ei-tykkäykseni.</Tooltip>
                    : <Tooltip id='buttonTooltip'>Mielestäni tämä kierrätysohje ei ole suositeltava.</Tooltip>}>
                  <Button variant={disLike ? 'danger' : 'outline-danger'} id="dislikeButton" onClick={handleDislike}>
